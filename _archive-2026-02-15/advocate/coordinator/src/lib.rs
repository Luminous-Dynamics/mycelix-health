...
pub fn get_patient_preps(patient_hash: ActionHash) -> ExternResult<Vec<Record>> {
    ...
    let links = get_links(
        LinkQuery::try_new(patient_hash.clone(), LinkTypes::PatientToPreps)?,
        GetStrategy::default(),
    )?;
...
pub fn get_patient_insights(patient_hash: ActionHash) -> ExternResult<Vec<Record>> {
    ...
    let links = get_links(
        LinkQuery::try_new(patient_hash.clone(), LinkTypes::PatientToInsights)?,
        GetStrategy::default(),
    )?;
...
pub fn get_patient_reviews(patient_hash: ActionHash) -> ExternResult<Vec<Record>> {
    ...
    let links = get_links(
        LinkQuery::try_new(patient_hash.clone(), LinkTypes::PatientToReviews)?,
        GetStrategy::default(),
    )?;
...
pub fn get_provider_reviews(provider_hash: ActionHash) -> ExternResult<Vec<Record>> {
    // Provider reviews can contain patient-written details; restrict to the provider.
    ...
    if provider_record.action().author() != &caller {
        return Err(wasm_error!(WasmErrorInner::Guest(
            "Only the provider can view their reviews".to_string()
        )));
    }
...
pub fn get_patient_alerts(patient_hash: ActionHash) -> ExternResult<Vec<Record>> {
    ...
    let links = get_links(
        LinkQuery::try_new(patient_hash.clone(), LinkTypes::PatientToAlerts)?,
        GetStrategy::default(),
    )?;
...
pub fn get_patient_sessions(patient_hash: ActionHash) -> ExternResult<Vec<Record>> {
    ...
    let links = get_links(
        LinkQuery::try_new(patient_hash.clone(), LinkTypes::PatientToSessions)?,
        GetStrategy::default(),
    )?;
...
pub fn get_patient_medication_checks(patient_hash: ActionHash) -> ExternResult<Vec<Record>> {
    ...
    let links = get_links(
        LinkQuery::try_new(patient_hash.clone(), LinkTypes::MedicationChecks)?,
        GetStrategy::default(),
    )?;
...
pub fn get_latest_medication_check(patient_hash: ActionHash) -> ExternResult<Option<Record>> {
    ...
    let checks = get_patient_medication_checks(patient_hash.clone())?;
...
pub fn get_patient_questions(patient_hash: ActionHash) -> ExternResult<Vec<Record>> {
    ...
    let links = get_links(
        LinkQuery::try_new(patient_hash.clone(), LinkTypes::PatientToQuestions)?,
        GetStrategy::default(),
    )?;
