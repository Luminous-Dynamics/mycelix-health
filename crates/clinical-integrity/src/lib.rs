...
pub enum DigestDomain {
    ...
    ClinicalCausalQualifiedAttestation,
    ClinicalCausalAttestationCorrection,
    ClinicalRegulatoryInterpretation,
    ClinicalPopulationSignalPolicy,
    ClinicalSafetySignalCandidate,
    ClinicalPopulationCohort,
    ClinicalPopulationAssociationPolicy,
    ClinicalPopulationAssociation,
    ClinicalCausalEffectPolicy,
    ClinicalCausalEffectEstimate,
    ClinicalPopulationReplication,
    EvidenceCapsule,
    MedicationOrder,
...
impl DigestDomain {
    fn label(self) -> &'static [u8] {
        match self {
            ...
            Self::ClinicalCausalQualifiedAttestation => b"clinical-causal-qualified-attestation",
            Self::ClinicalCausalAttestationCorrection => b"clinical-causal-attestation-correction",
            Self::ClinicalRegulatoryInterpretation => b"clinical-regulatory-interpretation",
            Self::ClinicalPopulationSignalPolicy => b"clinical-population-signal-policy",
            Self::ClinicalSafetySignalCandidate => b"clinical-safety-signal-candidate",
            Self::ClinicalPopulationCohort => b"clinical-population-cohort",
            Self::ClinicalPopulationAssociationPolicy => b"clinical-population-association-policy",
            Self::ClinicalPopulationAssociation => b"clinical-population-association",
            Self::ClinicalCausalEffectPolicy => b"clinical-causal-effect-policy",
            Self::ClinicalCausalEffectEstimate => b"clinical-causal-effect-estimate",
            Self::ClinicalPopulationReplication => b"clinical-population-replication",
            ...
            Self::PatientSubjectBindingEvidence => b"patient-subject-binding-evidence",
